...
BEGIN
	...
	INSERT INTO CONTENT_API.SITE (SITE_SHORTNAME, SITE_FULLNAME, SITE_BASEURL, SITE_OWNER, SITE_ACTIVE, SITE_STARTDATE, SITE_ENDDATE, AUTH_REQUIRED, SVC_ACCTNAME, SVC_ACCTPWD)
	VALUES('sample-site', 'Sample Site', 'NA', 'DoITT Content API Dev', 'Y', TIMESTAMP '2017-11-01 00:00:00.000000', TIMESTAMP '2029-12-31 00:00:00.000000', 1, 'ContentApi-SampleSite-DEV', 'VqGo0PqGnZTJL3mEEfBq8SLhoMWRNHnZerIi7c1ZYGctvV9j684hw8OpiEsAwWpan7A4upWas3hXVrG6mEVWSTCB2qOug8Zana4jJ+27DYY=');
	...
	VALUES ('Y', 'sample', 'Public', 'home', 'sample-site', 'sampletag', 'This is some sample generic content for the sample site sample page.');
